...
OBJS=main.o input-sdl.o vid-sdl.o platform-sdl.o model.o model-iqm2.o camera.o renderer-gl3.o matrix-sw.o quat-sw.o texture.o texture-png.o resource.o
BINARYNAME=test
