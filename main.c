...
int main(int argc, char **argv) {
  ...
  kl_vec3f_t light2_pos = { .x = -500.0f, .y = 400.0f, .z = 0.0f };
  kl_render_add_light(&light2_pos, 1.0f, 0.8f, 0.6f, 25000.0f);
        ...
        case KL_EVT_BUTTON:
          switch (evt.button.code) {
            ...
            case KL_BTN_6:
              ...
              break;
            case KL_BTN_7:
              kl_render_set_debug(6);
              break;
            case KL_BTN_8:
              kl_render_set_debug(7);
              break;
            case KL_BTN_9:
              kl_render_set_debug(8);
              break;
          }
          break;
        case KL_EVT_MOUSE:
