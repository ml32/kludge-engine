...
"void main() {\n"
"  vec4 clip = vpmatrix * vec4(vposition, 1.0);\n"
"  fdepth    = clip.z/clip.w;\n"
"  ftexcoord = vtexcoord;\n"
"\n"
...
"  vec4  coord = ivpmatrix * vec4(texcoord * 2.0 - 1.0, depth, 1.0);\n"
"  coord.xyz /= coord.w;\n"
"  float dist  = distance((light.position).xyz, coord.xyz);\n"
"  float luminance = light.color.a / (dist * dist);\n"
""
"  vec3 dir = mat3(vmatrix[0].xyz, vmatrix[1].xyz, vmatrix[2].xyz) * normalize(light.position.xyz - coord.xyz);\n"
""
"  vec3 norm;\n"
