...
"  vec3 n_eye   = normalize(viewtbnmatrix * n_local);\n"
"\n"
"  gdepth    = fdepth;\n"
"  gdiffuse  = diffuse;\n"
...
"    vec3  occluder_normal = decode_normal(texture(tnormal, sample_offsets[i] * screen_scale + gl_FragCoord.xy).rg);\n"
